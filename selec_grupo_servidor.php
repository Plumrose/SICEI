...
function datos(cod,nombre){
  opener.document.form1.tipo_serv.value=cod;
  opener.document.form1.Descrip_serv.value=nombre;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Lista de Selecci&oacute;n - Tipos de Servidores </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_grupo_servidor.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
    ...
    <table width="493" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){	
              $sql01="select des_tipo_serv as des, cod_tipo_serv as id from m_tipo_servidores";
		   }else{
              $sql01="select des_tipo_serv as des, cod_tipo_serv as id from m_tipo_servidores where des_tipo_serv like '%$nombre_busqueda%'";
		   }	  
