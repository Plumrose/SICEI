    ...
    <table width="786" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		  ...
		  descripcion, m_software.tipo_software as tipo_software from m_software, M_TIPO_SOFTWARE where m_software.tipo_software 
...
//         Versión			  
           ...
           if(mysql_num_rows($resultado)>0) 
	       {
    		  while($registro=mysql_fetch_assoc($resultado)){ 
				  ...
				  OnClick=\"datos('$cod_software','$tipo_software','$version','$estatus');\"><td>$cod_software</td> <td>$tipo</td><td>$version</td><td>$estatus</td></tr>";		
		    }
		   }
...
function datos(cod_software,tipo_software,version,estatus){
