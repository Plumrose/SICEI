    ...
    <table width="784" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		  ...
		  nro_inversion, responsable as responsable  from proyectos";
//        Código de Proyecto		   
       	   if($tipo_objeto=='01'){ 
             $sql01="select cod_proyecto as cod_proyecto, nom_proyecto as nom_proyecto, estatus as estatus, nro_inversion as 
			 nro_inversion, responsable as responsable from proyectos where cod_proyecto like '%$nombre_busqueda%'";
           }
//         Nombre del Proyecto			  
		   if($tipo_objeto=='02'){ 
             $sql01="select cod_proyecto as cod_proyecto, nom_proyecto as nom_proyecto, estatus as estatus, nro_inversion as 
			 nro_inversion, responsable as responsable from proyectos where nom_proyecto like '%$nombre_busqueda%'";
           }
//         Código de Inversión			  
		   if($tipo_objeto=='03'){ 
             $sql01="select cod_proyecto as cod_proyecto, nom_proyecto as nom_proyecto, estatus as estatus, nro_inversion as 
			 nro_inversion, responsable as responsable from proyectos where nro_inversion like '%$nombre_busqueda%'";
           }
           ...
           if(mysql_num_rows($resultado)>0) 
	       {
              ...
              { 
				  ...
				  OnClick=\"datos('$cod_proyecto','$nom_proyecto','$nro_inversion','$estatus','$responsable');\"><td>$cod_proyecto</td> <td>$nom_proyecto</td><td>$nro_inversion</td></tr>";		
		    }
		   }
...
function datos(cod_proyecto,nom_proyecto,nro_inversion,estatus,responsable){
  opener.document.form1.cod_proyecto.value=cod_proyecto;
  opener.document.form1.nom_proyecto.value=nom_proyecto;
  opener.document.form1.responsable.value=responsable;
  opener.document.form1.nro_inversion.value=nro_inversion;
