<?php
  ...
  $sql05="select NOMB_SOL as NOMB_SOL from m_solicitantes where COD_SOL='$cliente1'";
  $resul1=mysql_query($sql05,$conectar) or die("Problemas en la Sentencia SQL 5. ".mysql_error());
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Listado de Componentes Asignados al Usuario <?php echo $NOMB_SOL ?></p>

  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_equipos5.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="770">
    <tr>
      <td width="185"><div align="right"></div></td>
      <td width="573"><div align="right"></div></td>
      </tr>
    <tr>
      <td><div align="right">
        <select name="tipo_objeto" size="1" id="tipo_objeto" >
          <?php
          $opciones = array(01=>'Descripción Componente',02=>'Número Serial');
  ...
  <div id="resultado">
    <table width="1024" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        <td width="124" height="35" bgcolor="#003300"><span class="Estilo38">C&oacute;digo Comp.  </span></td>
        <td width="312" bgcolor="#003300"><span class="Estilo38">Descripci&oacute;n </span></td>
        <td width="198" bgcolor="#003300"><span class="Estilo38">N&uacute;mero Serial</span></td>
        <td width="362" bgcolor="#003300"><span class="Estilo38">Unidad Organizativa</span></td>
        </tr>
        <?php
