...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Lista de Selecci&oacute;n - Tipos de Proveedores </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_atrib_prov.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
    ...
    <table width="493" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){	
              $sql01="select DESC_TIPO_PROV as des, COD_TIPO_PROV as id from M_TIPOS_PROV";
		   }else{
              $sql01="select DESC_TIPO_PROV as des, COD_TIPO_PROV as id from M_TIPOS_PROV where DESC_TIPO_PROV like '%$nombre_busqueda%'";
		   }	  
