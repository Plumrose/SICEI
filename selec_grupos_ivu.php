...
function datos(cod,nombre){
  opener.document.form1.cod_tabla.value=cod;
  opener.document.form1.des_tabla.value=nombre;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41 Estilo42">Lista de Selecci&oacute;n - Tipos Grupos </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_tipo_tabla.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
    ...
    <table width="493" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){		
              $sql01="select cod_tabla as id, nombre_tabla as des from m_tipos_tablas order by cod_tabla ";
		   }else{
              $sql01="select cod_tabla as id, nombre_tabla as des from m_tipos_tablas where nombre_tablao like '%$nombre_busqueda%' order by cod_tabla ";
		   }	  
