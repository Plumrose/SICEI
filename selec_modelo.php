...
function datos(cod,nombre){
  opener.document.form1.cod_modelo.value=cod;
  opener.document.form1.des_modelo.value=nombre;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41 Estilo42">Lista de Selecci&oacute;n - Modelos </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_modelo.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
    ...
    <table width="493" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){		
              $sql01="select cod_modelo as id, desc_modelo as des from m_modelos order by desc_modelo";
		   }else{
              $sql01="select cod_modelo as id, desc_modelo as des from m_modelos where desc_modelo like 
			  '%$nombre_busqueda%' order by desc_modelo";
		   }	  
