...
<form id="form1" name="form1" method="post" action="selec_almacenes4.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="662">
...
//            Nombre 			  
           ...
           if(mysql_num_rows($resultado)>0) 
	       {
              ...
              { 
				  ...
				  OnClick=\"datos('$cod_almacen','$desc_almacen','$ubi_almacen');\"><td>$cod_almacen</td><td>$desc_almacen</td><td>
				  $ubi_almacen</td></tr>";		
		    }
		   }
...
function datos(cod_almacen,desc_almacen,ubi_almacen){
  opener.document.form1.cod_almacen2.value=cod_almacen;
  window.close();
}
function mano(a) {
