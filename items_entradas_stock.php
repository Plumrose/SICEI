...
#ccomponentes {	position:absolute;
	width:844px;
	height:45px;
	z-index:14;
	left: 2px;
...
<div id="ccomponentes">
  <table width="843">
    <tr>
      <td width="187" height="40"><div align="center"><span class="e-etiquetas_clave">Componente</span>
              <input name="cod_comp" type="text" class="e-campos_entradas" id="cod_comp" value="<?php echo $cod_comp; ?>" size="10" maxlength="10" />
      </div></td>
      <td width="238" class="e-etiquetas_clave"><div align="center">N&uacute;mero Serial
        <input name="nro_serial" type="text" class="e-campos_entradas" id="nro_serial" value="<?php echo $nro_serial; ?>" size="20" maxlength="20" />
      </div></td>
      <td width="180" class="e-etiquetas_clave"><div align="center">Cantidad
        <input name="cantidad" type="text" id="cantidad" value="<?php echo $cantidad; ?>" size="10" maxlength="10" />
      </div></td>
      <td width="77"><div align="center">
        <input name="b_anadir" type="submit" class="estilos_botones" id="b_anadir" value="  A&ntilde;adir  " />
      </div></td>
      <td width="70"><div align="center">
        <input name="b_eliminar" type="submit" class="estilos_botones" id="b_eliminar" value="Eliminar" />
      </div></td>
    </tr>
  </table>
  <div id="resultado">
    <table width="842" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        <td width="43" height="34" bgcolor="#3E5B15"><div align="center"></div></td>
        <td width="130" bgcolor="#3E5B15"><div align="left"><span class="Estilo38">Componente</span></div></td>
        <td width="308" bgcolor="#3E5B15" class="Estilo45"><span class="Estilo38">Descripci&oacute;n</span></td>
        <td width="163" bgcolor="#3E5B15"><span class="Estilo38">Nro. Serial </span></td>
        <td width="164" bgcolor="#3E5B15"><div align="left"><span class="Estilo38">Cantidad</span></div></td>
      </tr>
      <?php
           //CONECTAR CON LA BASE DE DATOS DE MYSQL
           $conectar=mysql_connect($_SESSION['servidor'],$_SESSION['usuario_adm'],$_SESSION['clave']) or
...
//                  echo "<tr><td>$ind</td><td>$cod_grupo_art</td><td>$desc_grupo_art</td><td>$cantidad</td></tr>";		
      ...
      <tr>
        <td><?php echo $ind; ?>
            <input type="checkbox" name="inddele[]"  id="inddele[]"  value="<?php echo $cod_grupo_art; ?>"/></td>
        <td><?php echo $cod_comp; ?></td>
    ...
    <div id="Layer69"><img src="imagenes/borrar.jpg" alt="borrar" width="20" height="18" /></div>
  </div>
</div>
<p class="efecha">&nbsp;</p>
