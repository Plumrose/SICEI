...
//         Versión			  
           ...
           if(mysql_num_rows($resultado)>0) 
	       {
    		  while($registro=mysql_fetch_assoc($resultado)){ 
				  ...
				  OnClick=\"datos('$cod_software','$nombre_sof');\"><td>$cod_software</td> <td>$tipo</td><td>$nombre_sof</td><td>$estatus</td></tr>";		
		    }
		   }
...
function datos(cod_software,nombre_sof){
