...
<body>
<div id="hh" style="width: 672px; height:380px; position: fixed; margin-left: -336px; margin-top: -190px; top:50%; left:50%; border:  1px solid #009933;">
  <div id="c_encabezado">
<div id="Contenedor">
  <div id="Layer43"></div>
  <p>&nbsp;</p>
    <div id="Layer44" title="Para ingresar al Sistema SICEI se deber&aacute; indicar el usuario y la Contrase&ntilde;a. Es importante indicar que al tercer intento fallido el usuario ser&aacute; bloqueado y deber&aacute; comunicarse con el Administrador del Sistema">
     <div id="Layer46"><img src="imagenes/img_main.png" alt="imagen" width="246" height="111" /></div>
