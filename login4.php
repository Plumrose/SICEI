...
if($btn=='Acceder al Sistema'){
  ...
  $sql1="SELECT cod_usuario as cod_usuario, nom_usuario as nom_usuario, ape_usuario as ape_usuario, 
  fec_ult_acceso as fec_ult_acceso, status_usuario as status_usuarios,fec_ult_cambio as fec_ult_cambio, 
  tipo_usuario as tipo_usuario FROM m_usuarios where cod_usuario='$usuario' AND password='$password'";
  $sql2="SELECT cod_usuario as cod_usuario, nom_usuario as nom_usuario, ape_usuario as ape_usuario, 
  fec_ult_acceso as fec_ult_acceso, status_usuario as status_usuarios,fec_ult_cambio as fec_ult_cambio, 
  tipo_usuario as tipo_usuario FROM m_usuarios where cod_usuario='$usuario'";
//------------------------------------------------------------------------------------------------  
// Inicio de autotentificación
  if $ind_sistema == '1'{
   $sUsuario = $usuario;
   $sClave   = $password;
   $sEmpresa = "Plumrose";
...
//-------------------------------------------------------------------------------------
// Fin Rutina de autotentificavion
