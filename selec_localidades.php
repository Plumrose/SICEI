...
<form id="form1" name="form1" method="post" action="selec_localidades.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="519">
      ...
      <tr>
        ...
        <?php
           ...
           mysql_select_db('siceiplum',$conectar) or
              ...
              $sql01="select cod_localidad as cod_localidad, desc_localidad as desc_localidad from m_localidades";
		   	  if($tipo_objeto=='01'){ 
                    $sql01="select cod_localidad as cod_localidad, desc_localidad as desc_localidad from m_localidades where 
