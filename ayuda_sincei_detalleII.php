...
// Toma el código de la transacción
  session_start();
  $codigo_transaction='SICEI_PAG_999';
//---------------------------------------------------------------------------
...
<div id="Layer65">
  <p><a href="index.php"><img src="imagenes/salirsistema.jpg" alt="regresar" width="29" height="29" border="0" title="Regresa a la opci&oacute;n donde fue llamada" longdesc="regresar" /></a></p>
  <p>&nbsp;</p>
</div>
<p>&nbsp;</p>
<p class="efecha">&nbsp;</p>
<div id="logo"><img src="imagenes/img_main.jpg" width="260" height="101" alt="logo1" /></div>
<form id="form1" name="form1" method="post" action="ayuda_sincei_detalleii.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <div id="busqueda">
  <div id="resultado">
