...
function datos(dunidad,cunidad){
  opener.document.form1.des_grupo.value=dunidad;
  opener.document.form1.cod_grupo.value=cunidad;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Listado Agrupaci&oacute;n de Localidades   </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_grupo_localidades.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="519">
      ...
      <tr>
        ...
        <?php
           ...
           mysql_select_db('siceiplum',$conectar) or
              ...
              $sql01="select cod_agrupacion as cod_localidad, des_agrupacion as desc_localidad from m_grupo_localidad";
		   	  if($tipo_objeto=='01'){ 
                    $sql01="select cod_agrupacion as cod_localidad, des_agrupacion as desc_localidad from m_grupo_localidad where 
					cod_agrupacion like '%$nombre_busqueda%'";
		      }
		   	  if($tipo_objeto=='02'){ 	
                    $sql01="select cod_agrupacion as cod_localidad, des_agrupacion as desc_localidad from m_grupo_localidad where 
					des_agrupacion like '%$nombre_busqueda%'";
		      }
              ...
              { 
				  ...
				  OnClick=\"datos('$dunidad','$cunidad');\"><td>$cunidad</td><td>$dunidad</td></tr>";
   		      }
		   } 
