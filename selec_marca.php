...
function datos(cod,nombre){
  opener.document.form1.cod_marca.value=cod;
  opener.document.form1.des_marca.value=nombre;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41 Estilo42">Lista de Selecci&oacute;n - Marcas </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_marca.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
  ...
  <div id="resultado">
    <table width="491" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){		
              $sql01="select cod_marca as id, desc_marca as des from m_marcas order by cod_marca";
		   }else{
              $sql01="select cod_marca as id, desc_marca as des from m_marcas where desc_marca like '%$nombre_busqueda%' order by cod_marca";
		   }	  
