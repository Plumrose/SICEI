...
function datos(codigo,desc){
  opener.document.form1.cod_grupo.value=codigo;
  opener.document.form1.des_grupo.value=desc;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Grupo de Componentes   </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_grupos.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="519">
        ...
        <?php
           ...
           mysql_select_db('siceiplum',$conectar) or
                die("ERROR con la base de datos");
                   $sql01="select grupo_comp as cod_grupo, descripcion as descripcion from m_grupo_componentes order by cod_grupo";
			  if($tipo_objeto=='01'){ 
                    $sql01="select grupo_comp as cod_grupo, descripcion as descripcion from m_grupo_componentes where grupo_comp like 
					'%$nombre_busqueda%' order by cod_grupo";
		      }
		   	  if($tipo_objeto=='02'){ 	
                    $sql01="select grupo_comp as cod_grupo, descripcion as descripcion from m_grupo_componentes where descripcion like 					'%$nombre_busqueda%' order by cod_grupo";
		      }
