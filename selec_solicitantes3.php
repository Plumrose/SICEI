...
<form id="form1" name="form1" method="post" action="selec_solicitantes3.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="662">
    ...
    <tr>
      <td><select name="tipo_objeto" size="1" id="tipo_objeto" >
        <?php
          $opciones = array(01=>'Código Solicitante',02=>'Nombre del Solicitante',03=>'Unidad',04=>'Gerencia');
        ...
        <?php
           ...
           mysql_select_db('siceiplum',$conectar) or
             ...
             $sql01="select cod_sol as cod_sol, nomb_sol as nomb_sol,cod_unidad as cod_unidad,cod_gerencia as 
	     		   cod_gerencia, cod_localidad as cod_localidad from m_solicitantes ";	
//            Código de Solicitante		   
		   	  if($tipo_objeto=='01'){ 
                 $sql01="select cod_sol as cod_sol, nomb_sol as nomb_sol,cod_unidad as cod_unidad,cod_gerencia as 
	     		   cod_gerencia, cod_localidad as cod_localidad from m_solicitantes where cod_sol like '%$nombre_busqueda%'";	
              }
//            Nombre del Solicitante			  
		   	  if($tipo_objeto=='02'){ 
                 $sql01="select cod_sol as cod_sol, nomb_sol as nomb_sol,cod_unidad as cod_unidad,cod_gerencia as 
	     		   cod_gerencia, cod_localidad as cod_localidad from m_solicitantes where nomb_sol like '%$nombre_busqueda%'";	
              }
//            Por Unidad			  
		   	  if($tipo_objeto=='03'){ 
                 $sql01="select cod_sol as cod_sol, nomb_sol as nomb_sol,cod_unidad as cod_unidad,cod_gerencia as 
	     		   cod_gerencia, cod_localidad as cod_localidad from m_solicitantes where cod_unidad like '%$nombre_busqueda%'";	
              }
//           Por Gerencia			  
		   	  if($tipo_objeto=='04'){ 
                 $sql01="select cod_sol as cod_sol, nomb_sol as nomb_sol,cod_unidad as cod_unidad,cod_gerencia as 
	     		   cod_gerencia, cod_localidad as cod_localidad  from m_solicitantes where cod_gerencia like '%$nombre_busqueda%'";	
              }
           ...
           if(mysql_num_rows($resultado)>0) 
	       {
              ...
              { 
				  ...
				  $cod_sap=$registro['cod_gerencia'];
				  $cod_sap=str_replace(" ","&nbsp;",$cod_sap);
				  $sql02="select desc_unidad as desc_unidad, desc_gerencia as desc_gerencia from m_jerarquia_org where 
				  cod_unidad = '$cod_unidad' and cod_gerencia = '$cod_gerencia'";
                  ...
                  echo "<tr OnMouseOver=Resaltar_On(this);' OnMouseOut='Resaltar_Off(this);' OnClick=\"datos('$solicit_sol','$desc_solicit','$cod_sap','$cod_unidad','$des_unidad','$cod_gerencia','$des_gerencia','$cod_localidad','$desc_localidad');\"><td>$solicit_sol</td><td>$cod_unidad</td><td>$cod_gerencia</td><td>$desc_solicit</td></tr>";		
		    }
		   }
...
function datos(solicit_sol,desc_solicit,cod_sap,cod_unidad,des_unidad,cod_gerencia,des_gerencia,cod_localidad,desc_localidad){
