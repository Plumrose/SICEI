...
function datos(cod,nombre){
  opener.document.form1.tipo_prov.value=cod;
  opener.document.form1.Desc_tipo_prov.value=nombre;
  window.close();
}
</script>
...
<div id="Layer1">
  <div align="center" class="Estilo28">
    <p class="Estilo41">Lista de Selecci&oacute;n - Grupos de Proveedores </p>
  </div>
</div>
<form id="form1" name="form1" method="post" action="selec_grupo.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<div id="busqueda">
  <table width="466">
    ...
    <table width="493" border="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="Estilo28">
      <tr>
        ...
        <?php
		   ...
		   if($nombre_busqueda==''){	
              $sql01="select cod_tipo_prov as id, desc_tipo_prov as des from m_tipos_prov";
		   }else{
              $sql01="select cod_tipo_prov as id, desc_tipo_prov as des from m_tipos_prov where desc_tipo_prov like '%$nombre_busqueda%'" ;
		   }	  
